...
| 角色 | 本样例 example-demo 的名字 | 抽取脚本对它的特殊处理 |
|---|---|---|
...
## 在 example-demo 里怎么填的

`example-demo/scripts/extract_trajectories.py` 用三个参数指明角色名，默认值恰好命中本样例：

```bash
python example-demo/scripts/extract_trajectories.py --traj-dir <轨迹目录> --out-dir <工作目录> \
